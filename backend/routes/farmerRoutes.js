...
import {getFarmers,getFarmersForOneAgent, getFarmerById,deleteFarmer,createFarmer, updateFarmer,getTopFarmers,createFarmerReview, updateFarmerStockCount, getFarmerByPhone,getAllFarmers,updateFarmerInput, updateFarmerHarvest,deleteFarmerSingleInput,updateFarmerSingleInput} from '../controllers/farmerControllers.js'
...
router.route('/updateInput').post(updateFarmerInput)
router.route('/updateHarvest').post(updateFarmerHarvest)

router.route('/deleteSingleInput').post(deleteFarmerSingleInput)

router.route('/updateSingleInput').post(updateFarmerSingleInput)
