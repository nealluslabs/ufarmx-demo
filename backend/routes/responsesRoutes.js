...
import {getResponses,getAllResponses,getAllResponsesForOneAgent, updateResponseAndFarmer, /*getDepositById,*/ createResponse,updateResponse, getLastThreeResponses, getSpecificResponse, /*deleteResponses,updateResponses,getTopResponses,createResponsesReview, updateResponsestockCount, getResponsesByPhone,*/} from '../controllers/responseControllers.js'
...
router.route('/update-response-and-farmer').post(/*protect,*/updateResponseAndFarmer); // updateResponseAndFarmer

router.route('/all').get(getAllResponses)
