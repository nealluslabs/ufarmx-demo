...
export default function ContainerHomeCard({ headerOne, headerTwo, value, type,image,farmerName,farmName,phoneNumber,email,city }) {
    ...
    <>
      ...
      <Grid container alignItems="center">
        <Grid item xs={12} style={{ textAlign: 'center',height:"10.5rem",display:"flex", }}>
          ...
          <img src={image} style={{marginLeft:"2rem",marginBottom:"1rem",height:"9rem",width:"9rem",borderRadius:"1.5rem"}} alt="farmer image"/>
