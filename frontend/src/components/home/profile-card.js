...
export default function ProfileCard({ headerOne, headerTwo, value, type }) {
  ...
  return (
    <>
      ...
      <Grid container alignItems="center">
        <Grid item xs={12} style={{ textAlign: 'center',height:"10rem" }}>
          
          <img src={redboy} style={{marginLeft:"2rem",marginBottom:"1rem",height:"10rem",borderRadius:"1.5rem"}} alt="athlete image"/>
