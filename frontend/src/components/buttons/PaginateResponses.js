...
import {sectionResponsesFromPage} from 'src/redux/actions/group.action'


const PaginateResponses = ({pages=10,page=1, isAdmin=false, keyword='',allResponses=[],filteredResponses=[]}) => {
   ...
   const dispatch = useDispatch()
    ...
    const handlePageChange = (event, value) => {
      ...
      setTimeout(()=>{
      navigate(`/dashboard/responses/${value}`);
        }
      )
    };
