...
const CampaignCard = ({data,index,user,pic,collection,about,signed}) => {
  ...
  return (
    ...
    <div className={classes.row}>
      ...
      <div style={{ display:"flex",flexDirection:"column",justifyContent:"flex-start",gap:"1px" ,width:"75%",paddingLeft:"8rem"}}>
          ...
          <div  style={{fontWeight:"500",fontSize:"3rem"}}> {collection} </div>
      ...
      onClick={() => {
       // navigate('/dashboard/individual-campaign')
