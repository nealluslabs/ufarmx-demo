...
const PitchCardAthlete = ({data,index,user,pic,collection}) => {
  ...
  return (
    ...
    <div className={classes.row}>
      ...
      <div style={{ display:"flex",flexDirection:"column",justifyContent:"flex-start",gap:"1px" ,width:"75%",paddingLeft:"8rem"}}>
          ...
          <div style={{fontWeight:"800",fontSize:"1.5rem"}}> Norman Steven </div>
          <div  style={{fontWeight:"800",fontSize:"3.5rem"}}> {collection} </div>
          <div  style={{fontWeight:"800",fontSize:"1.5rem"}}>Clark University  </div>
...
export default PitchCardAthlete;
