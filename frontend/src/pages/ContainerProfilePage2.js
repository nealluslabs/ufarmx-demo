...
import ContainerLocationCard from 'src/components/home/container-location-card';
...
export default function ContainerProfilePage() {
  ...
  const crops = [
    {id:"0S91dTHhu7t0Zc6645Gb", cropName:"Corn",cropType:"Cash Crops",lastHarvest:"20",harvestDate:"01-01-2024",image:corn},
    {id:"75LPiOJKwtndeC67o5d3",cropName:"Potato",cropType:"Cash Crops",lastHarvest:"50",harvestDate:"01-01-2024",image:potato},
    {id:"8Gnbs3WPwJ7ZzzvHgORs",cropName:"Plantain",cropType:"Cash Crops",lastHarvest:"30",harvestDate:"01-01-2024",image:plantain},
 ...
 { /*const myCoolerGroups = myGroups?.length ? (
  ...
  return (
    <>
      ...
      <Container style={{scale:"0.9",position:"relative",top:"-3rem"}} maxWidth="xl">
       ...
       <ContainerLocationCard headerOne={'Statistics'} headerTwo={'Profile'} value={''} type={'one'} image={cropcompany} farmName={'Jenkins Farm'} farmerName={"41°24'12.2\"N 2°10'26.5\"E" } city={"Dakar, Senegal"} email={"jjenkins@gmail.com"} phoneNumber={"+221 555-380-1000"} />
            </div>
          </Grid>

          <Grid item xs={8} md={12} lg={6}>
            <div style={{ background:'white' /*'#F8F8F8'*/, padding: '10px' }}>
              <CampaignCard headerOne={'Statistics'} headerTwo={'Agent'} value={''} type={'two'}  farmName={'Jenkins Farm'} farmerName={"Djibril Cisse"} city={"Dakar, Senegal"} email={"djibril@ufarmx.com"} phoneNumber={"+221 555-123-1000"}  image={redboy}/>
            </div>
          </Grid>
   ...
   {/*here */}
       ...
       {/**here 2 */}
         <Grid container spacing={2} sx={{ padding: '10px'}}>
         <Grid item xs={3} sx={{mb: 0}}>
       <p style={{fontSize:"24px",fontWeight:"600",position:"relative",top:"-1.2rem",left:"2rem"}}>Inventory</p>
        </Grid>
